from A1_1 import get_word_frequencies, get_word_feature_vector
...
def test_get_word_frequencies_1():
    ...
    assert get_word_frequencies(doc) == frequencies
...
def test_get_word_feature_vector_1():
    ...
    assert get_word_feature_vector(frequencies, vocabulary) == feature_vector
