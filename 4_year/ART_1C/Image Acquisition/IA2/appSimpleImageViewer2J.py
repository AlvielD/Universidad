...
class MainWindow(QMainWindow):
	...
	def initMenu(self):
		...
		qaBlackDots = QAction('blackDots', self)
		qaBlackDots.setShortcut('Ctrl+B')
		qaBlackDots.setStatusTip('Find black pixels on the image')
		...
		diceMenu.addAction(qaBlackDots)
		return
...
# Methods for Edit menu
	...
	def blackDots(self):
		...
		npImage = qimage2ndarray.rgb_view(image)
		# TODO Detect black pixels on the image
