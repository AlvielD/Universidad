...
insert into RALLY values ('R004','Rally RAC de Gran Bretaña','Reino 
Unido','30/11/2009');
...
Elena','C005',62);
insert into PILOTO values ('P003','Petter Solberg','B','-','Phil 
Mills','C002',26);
insert into PILOTO values ('P004','Mikko Hirvonen','AB','+','Jarmo 
Lehtinen','C003',57);
insert into PILOTO values ('P005','Marcus Gronholm','AB','-','Timo 
Rautiainen','C004',75);
